...
from vnpy.chart import ChartWidget, CandleItem, VolumeItem, MACDItem
...
class CandleChartDialog(QtWidgets.QDialog):
    ...
    def init_ui(self) -> None:
        ...
        # self.chart.add_plot("macd", maximum_height=200)  # 添加MACD的绘图区域
        self.chart.add_item(CandleItem, "candle", "candle")
        self.chart.add_item(VolumeItem, "volume", "volume")
        # self.chart.add_item(MACDItem, "macd", "macd")  # 添加MACDItem实例到对应绘图区域
